document.getElementById('submit-button').addEventListener('click', function() {
    ...
    if (score < 80) {
        resultDiv.innerHTML = `<p>Your score is ${score}. You are have Alzheimers Disease . Please consult a doctor.</p>
        <p>دراجاتك هي ${score}. أنت مصاب بمرض الزهايمر . يرجى استشارة الطبيب..</p>`;
