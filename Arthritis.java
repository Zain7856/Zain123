document.getElementById('submit-button').addEventListener('click', function() {
    ...
    if (score < 80) {
        resultDiv.innerHTML = `<p>Your score is ${score}. You are have Arthritis Disease . Please consult a doctor.</p>
        <p>درجاتك هي ${score}. أنت مصاب بالتهاب المفاصل . يرجى استشارة الطبيب.</p>`;
