document.getElementById('submit-button').addEventListener('click', function() {
    ...
    if (score < 80) {
        resultDiv.innerHTML = `<p>Your score is ${score}. You are have Osteoporosis Disease . Please consult a doctor.</p>
                                      <p>درجاتك هي ${score}. أنت مصاب بهشاشة العظام. يرجى استشارة الطبيب.</p>`;
