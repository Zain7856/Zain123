document.getElementById('submit-button').addEventListener('click', function() {
    ...
    if (score < 80) {
        resultDiv.innerHTML = `<p>Your score is ${score}. You are have Stroke Disease . Please consult a doctor.</p>
                                    <p>درجاتك هي ${score}. أنت مصاب بمرض السكتة الدماغية. يرجى استشارة الطبيب.</p>`;
