document.getElementById('submit-button').addEventListener('click', function() {
    ...
    if (score < 80) {
        resultDiv.innerHTML = `<p>Your score is ${score}. You are have Diabetes Disease . Please consult a doctor.</p>
                               <p>درجاتك هي ${score}. أنت مصاب بمرض السكري . يرجى استشارة الطبيب.</p>`;
